...
class LocalTuyaClimate(LocalTuyaEntity, ClimateEntity):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._fan_modes = DictSelector(self._config.get(CONF_FAN_SPEED_LIST, {}))
    ...
    def supported_features(self):
        ...
        if self._fan_speed_dp and self._fan_modes.names:
    ...
    def fan_mode(self):
        ...
        if not (fan_value := self.dp_value(self._fan_speed_dp)):
            return None
        return self._fan_modes.to_ha(fan_value)

    @property
    def fan_modes(self) -> list:
        """Return the list of available fan modes."""
        return self._fan_modes.names
    ...
    async def async_set_fan_mode(self, fan_mode):
        ...
        await self._device.set_dp(self._fan_modes.to_tuya(fan_mode), self._fan_speed_dp)
